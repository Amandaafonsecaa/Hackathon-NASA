...
from routers import neo_router, simulate_router, risk_router, geo_router, geojson_router, evacuation_router, report_router, health_router, environmental_router, satellite_router, earthdata_router, population_router, civil_defense_router
